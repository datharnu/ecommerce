  ...
  return (
    <div className="max-w-7xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
      ...
      <div className="space-y-6">
        ...
        <section>
          <h2 className="text-sm mb-4">SECTION 1 - ONLINE STORE TERMS</h2>
          <p className="text-[14px]">
        ...
        <section>
          <h2 className="text-sm mb-4">SECTION 2 - GENERAL CONDITIONS</h2>
          <p className="text-[14px]">
        ...
        <section>
          ...
          <p className="text-[14px]">
            ...
            quantities and are subject to store credit or exchange only
            according to our Return Policy. In the case of the rare refund that
            we may issue at our sole discretion, transactions are subject to a
            10% restock fee to cover the original processing fees we are
            charged, the return processing fees we are charged, commission fees
            and the overage we paid to ship your item beyond the cost of
            shipping you paid. As a small business, absorbing these costs in the
        ...
        <section>
          ...
          <p className="text-[14px]">
            ...
            are not responsible for lost, missing, or stolen packages. All
            orders will be shipped to the SHIPPING address provided during the
            time order was placed.
          </p>
        </section>
        <section>
          <h2 className="text-sm mb-4">SECTION 7 - OPTIONAL TOOLS</h2>
          <p className="text-[14px]">
        ...
        <section>
          <h2 className="text-sm mb-4">SECTION 8 - THIRD-PARTY LINKS</h2>
          <p className="text-[14px]">
        ...
        <section>
          <h2 className="text-sm mb-4">SECTION 10 - PERSONAL INFORMATION</h2>
          <p className="text-[14px]">
        ...
        <section>
          <h2 className="text-sm mb-4">SECTION 12 - PROHIBITED USES</h2>
          <p className="text-[14px]">
        ...
        <section>
          <h2 className="text-sm mb-4">SECTION 14 - INDEMNIFICATION</h2>
          <p className="text-[14px]">
            You agree to indemnify, defend and hold harmless MyShop, LLC and our
        ...
        <section>
          <h2 className="text-sm mb-4">SECTION 15 - SEVERABILITY</h2>
          <p className="text-[14px]">
        ...
        <section>
          <h2 className="text-sm mb-4">SECTION 16 - TERMINATION</h2>
          <p className="text-[14px]">
        ...
        <section>
          <h2 className="text-sm mb-4">SECTION 17 - ENTIRE AGREEMENT</h2>
          <p className="text-[14px]">
        ...
        <section>
          <h2 className="text-sm mb-4">SECTION 18 - GOVERNING LAW</h2>
          <p className="text-[14px]">
            These Terms of Service and any separate agreements whereby we
            provide you Services shall be governed by and construed in
            accordance with the laws of Virginia, USA.
          </p>
        </section>
        <section>
          <h2 className="text-sm mb-4">
        ...
        <section>
          <h2 className="text-sm mb-4">SECTION 20 - CONTACT INFORMATION</h2>
          <p className="text-[14px]">
            Questions about the Terms of Service should be sent to us at
            rodellee@adoredvintage.com.
          </p>
        </section>
        <p className="my-5"> --------------------------------------</p>
      </div>
