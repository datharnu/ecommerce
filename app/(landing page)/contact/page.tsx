  ...
  return (
    <div className="flex flex-col items-center justify-cente mb-56">
      ...
      <div className="text-center text-[15px] max-w-5xl flex flex-col gap-5 ">
        ...
        typically within 24-48 hours. Kindly note, multiple e-mails within a 24
        hour period will automatically flag your email as spam and we do not
        frequently check our spam folders. For e-mail inquiries about orders,
        returns, and store credit, please provide your Order Number, First and
        Last Name on your account, and the e-mail address associated with your
        account.
      </div>
    </div>
  );
